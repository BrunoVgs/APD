        ...
        */
        ...
        for($i=0; $i < 2; $i++) {
            ...
            foreach($players as $player) {
                $player10 = new Player();
                $player10->setTeam($team);
                $player10->setFirstName($player->firstName);
                $player10->setLastName($player->firstName);
                $player10->setNationality('France');
                $player10->setPosition($player->CF);
                $player10->setAge($player->age);
                $player10->setHeight($player->height);
                $player10->setCreatedAtValue();
                $manager->persist($player10);
            }
