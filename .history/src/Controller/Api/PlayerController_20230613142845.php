...
class PlayerController extends AbstractController
{
     ...
     * exemple d'utilisation : http://votresite.com/api/players/search?searchTerm=killian
     */
    public function searchPlayer(Request $request) {
        // On récupère le param searchTerm dans la request

        // avec le param je vais utiliser une méthode custom de mon repository PlayerRepository, qui va faire une recheche dans ma 
        // table player, en cherchant si searchTerm correspond soit au prénom, soit au nom
